  ...
  return (
    <div className="font-dm-sans pt-16 pb-12 md:flex md:justify-between">
      <div className="pb-8 md:max-w-4/12 ">
        <h2 className="max-w-56 sm:max-w-72 md:max-w-96 mb-4 font-medium tracking-normal">
          Facing an Issue? Let’s Fix It Fast
        </h2>
        <p className="opacity-80">
          Facing an issue with our product? Let us know the details, and we’ll
      ...
      <form action="" className="pt-4 md:max-w-6/12 w-full flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2 text-start">
          ...
          <select
            name="products"
            className="text-gray-500 select-styled"
            id="products"
          >
        ...
        <PrimaryButton className="mt-1">Submit Issue</PrimaryButton>
      </form>
    </div>
  );
};
